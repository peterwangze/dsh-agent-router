      ...
      return el('div', { className: 'dshrouter-card' },
        ...
        el('div', { className: 'dshrouter-row' },
          el('div', { className: 'dshrouter-field', style: { flex: '1 1 320px' } },
            ...
            el('input', {
              className: 'dshrouter-input', value: modelsValue, placeholder: 'gpt-5.6-sol, gpt-5.6-terra, gpt-5.6-luna',
    ...
    function AgentsPage(props) {
      ...
      const addPresetAccount = async () => {
        ...
        const value = {
          ...
          publicClient: false, authUrl: '', tokenUrl: '', scope: '', models: ['gpt-5.6-sol', 'gpt-5.6-terra', 'gpt-5.6-luna'], tokenRef: '',
        }
