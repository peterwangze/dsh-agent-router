...
export const ROUTER_DESCRIPTORS = [
  ...
  {
    id: 'dsh-agent-router#router/imagePrompt',
    service: 'router',
    namespace: 'router',
    method: 'imagePrompt',
    invocation: { kind: 'direct' },
    parameters: [parameter('request', wireCodecs.imagePromptRequest)],
    result: result('ImagePromptResult', wireCodecs.imagePromptResult),
  },
  {
