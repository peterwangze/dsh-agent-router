...
| P1 | REL-007 | v0.4.1 发布链——EVO-011 订阅生图 + EVO-012 画布架构 + FIX-020/021 显示链 + AUDIT-001 并发审计承载 | EVO-011✅ EVO-012✅ AUDIT-001✅ + 用户验证（生图直达显示/纯图标按钮）+ 用户指令发布（2026-09-01） | 0.4.1 | 进行中——TRIAGE-REL-007 机录；E-1 bump/CHANGELOG/README → E-2 门控 → E-3 冷装 → Release Reviewer → E-5 tag/push/Release |
