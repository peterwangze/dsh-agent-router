...
| — | 下一轮 | **暂停（用户裁决 2026-08-31，FIX-016 插队中）**——v0.4.0 发布链待用户下次指令接续（EVO-009 + FIX-015 + FIX-016 在 main 未发布）；后续待用户需求（FIX-008 残留 / C-4+C-5 / CI 面 RISK-001 / 插件仓 FIX-281） | — | 0.4.0 | 暂停待指令（P0 修复不受暂停影响） |
