...
.dshrouter-category{border:1px solid var(--dsw-alias-border-l2);border-radius:12px;display:flex;flex-direction:column}
...
.dshrouter-category-body{border-top:1px solid var(--dsw-alias-border-l3);padding:12px 14px;display:flex;flex-direction:column;gap:10px}
`
