...
`
      ...
      return el('div', { className: 'dshrouter-card' },
        ...
        expanded ? el('div', { className: 'dshrouter-stats' },
          ...
          configured ? el('div', { className: 'dshrouter-stats' },
            ...
            el('p', { className: 'dshrouter-hint' }, t('oauthAfterLoginHint'))) : el('div', { className: 'dshrouter-stats' },
    ...
    function AgentsPage(props) {
      ...
      const discoverOauth = async (id) => {
        ...
        setOauthNotice((current) => ({ ...current, [id]: outcome.ok ? `已发现 ${response.value.models.length} 个模型并合并到模型列表` : outcome.message }))
      }
