...
[![version](https://img.shields.io/badge/version-v0.1.4-blue)](https://github.com/peterwangze/dsh-agent-router/releases)
...
1. 下载发行包：[dsh-agent-router-v0.1.4.tar.gz](https://github.com/peterwangze/dsh-agent-router/releases/download/v0.1.4/dsh-agent-router-v0.1.4.tar.gz)
2. 解压并进入包目录：
