...
`
     ...
     *  scope 为 Gemini API 现行组合（旧 generativelanguage scope 已被
     *  Google 拒绝：授权页「禁止访问：发生了授权错误」）。 */
    const GEMINI_OAUTH_SCOPES = 'https://www.googleapis.com/auth/cloud-platform https://www.googleapis.com/auth/generative-language.retriever'
    const OAUTH_PRESETS = [
