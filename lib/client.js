...
`
    ...
    function AgentsPage(props) {
      ...
      const [openSections, setOpenSections] = useState({ account: false, stats: false })
      ...
      return el('section', { className: 'dshrouter-section', 'aria-label': t('title') },
        ...
        // ── 多模态账号管理（卡片列表 + 末尾「+」，与专业 Agent 一致）─────
        el(SectionCard, {
          title: t('accountTitle'),
          summary: t('accountSummary')(addedAccounts.length),
