...
| FIX-003C | development（收尾批次） | FIX-003 R1 遗留三修（F-1/F-2/F-3） | F-1 dshHomeAttachmentsRoot env 缺省回退补 .dsh（1 行，与注释及宿主默认一致）；F-3 哈希兜底分支与环境 fallback 补 B13c/d/e 三断言；F-2 probeImageDimensions VP8X off-by-N（24 vs 30）修正 | **进行中（2026-08-23 派发+c0ee8dc2 承接，EVO-002 Step 7 并行——文件域不重叠）**；验收 = routing-paths 101/101 + smoke 849 基线零回退 + Code Reviewer 审查 | P1 |
