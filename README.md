...
[![version](https://img.shields.io/badge/version-v0.1.3-blue)](https://github.com/peterwangze/dsh-agent-router/releases)
...
固定版本：把命令中的 `main` 换成版本号，如 `v0.1.3`。

### 离线安装

1. 下载发行包：[dsh-agent-router-v0.1.3.tar.gz](https://github.com/peterwangze/dsh-agent-router/releases/download/v0.1.3/dsh-agent-router-v0.1.3.tar.gz)
2. 解压并进入包目录：

```powershell
# Windows
tar -xzf dsh-agent-router-v0.1.3.tar.gz
cd dsh-agent-router-v0.1.3
