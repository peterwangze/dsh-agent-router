 ...
 * lib/preset-defaults.js 的 presetDiag/notePresetDiag：模块级有界环形 +
 * 字段白名单 + 截断 + try/catch 全防护）+ FaceHealth 形状与 probe 运行器（惰性）。
 *
 ...
 * 字段白名单 + 长度截断（presetDiag/notePresetDiag 纪律同构），诊断失败绝不
 * 影响主链。
 */
