...
`
     ...
     *  受限 scope（公开 client 报 403 restricted_client）。注意：公开
     *  client 的 token 仅完成授权，Google 不允许其调用 Gemini API
     *  （403 insufficient scopes）；实际调用需自建 Client（scope 用
     *  GEMINI_SELF_CLIENT_SCOPES）或用 Gemini API Key。 */
